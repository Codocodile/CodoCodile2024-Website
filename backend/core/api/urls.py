...
urlpatterns = [
    ...
    path(
        "create-challenger/",
        views.ChallengerCreateAPIView.as_view(),
        name="add-challenger",
    ),
    path("cv/", views.ChallengerCVAPIView.as_view(), name="add-cv"),
    path(
        "confirm-challenger/",
        views.ChallengerConfirmAPIView.as_view(),
        name="confirm-challenger",
    ),
    path(
        "update-challenger/",
        views.ChallengerUpdateAPIView.as_view(),
        name="update-challenger",
    ),
    path(
        "view-challenger/",
        views.ChallengerViewAPIView.as_view(),
        name="view-challenger",
    ),
    path(
        "search-challenger/",
        views.ChallengerSearchAPIView.as_view(),
        name="search-challenger",
    ),
    path("team/", views.GroupAPIView.as_view(), name="team"),
    path("invitation/", views.InvitationRequestAPIView.as_view(), name="invitation"),
    path(
        "accept-invitation/",
        views.InvitationAcceptanceAPIView.as_view(),

    ...
    <div className="min-h-screen bg-gradient-hero flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <Link
            href="/"
            className="flex items-center justify-center space-x-3 rtl:space-x-reverse mb-6"
          >
            ...
            <div className="flex flex-col">
              <span className="text-3xl font-bold text-gradient">کدوکدیل</span>
              <span className="text-sm text-neutral-600">CodoCodile 2025</span>
            </div>
          </Link>

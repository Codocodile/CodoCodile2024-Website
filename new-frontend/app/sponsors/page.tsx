...
const sponsors = [
  ...
  },
  {
    ...
    description:
      "مسیر اسنپ ۱۱ سال پیش با ایده‌ای پیشرو و نوآور آغاز شد و مرزهای خدمت‌رسانی را جابه‌جا کرد. امروز اسنپ با تکیه بر تلاش‌های بی‌وقفه‌ی تیمی چندهزار نفره و همراهی میلیون‌ها کاربر راننده جریان زندگی را در دل روشنایی‌های شهر راحت و سریع کرده است.",

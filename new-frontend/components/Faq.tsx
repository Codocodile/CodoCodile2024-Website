...
const Faq = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "بله، قبل از شروع مسابقه کارگاه‌های آموزشی توسط تیم کدوکدیل برگزار می‌شوند تا مهارت شما را در کدنویسی الگوریتمی افزایش دهند.",
    },
    {
      id: 5,
      question: "مسابقه به صورت مجازی برگزار می‌شود یا حضوری؟",
      answer:
        "مسابقه دو مرحله دارد؛ مرحله‌ی اول به صورت مجازی برگزار می‌شود، سپس تیم‌های برتر مسابقه‌ی مجازی، به صورت حضوری و در دانشگاه صنعتی شریف به رقابت می‌پردازند.",
    },
    {
      id: 6,

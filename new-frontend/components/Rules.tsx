  ...
  const rules = [
    ...
    },
    {
      ...
      content: [
        ...
        "اعضای تیم می‌توانند در همان سطح (Junior/Senior/Pro) نباشند، اما سطح تیم معادل با بالاترین سطح اعضای تیم است",
    ...
    },
    {
      ...
      content: [
        ...
        "جوایز نقدی برای سه تیم برتر هر سطح در فاز حضوری",

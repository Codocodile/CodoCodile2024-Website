...
function Landing() {
    return (
        <>
            <Navbar/>
            <Header/>
            <Section name="introduction" side="right" dino={crocs[0]} font={"font-sans"} image={"assets/crocs/croc-introduction.png"}>
                <TextOnlySection
                    text={INTRODUCTION}
                    font={"font-sans"}/>
            </Section>

            <Section name="timeline" side="left" dino={crocs[1]} font={"font-sans"} image={"assets/crocs/croc-timeline.png"}>
                <EventTimeline events={TIMELINE_DATA}/>
            </Section>
            {/*{<Section name="staff">*/}
            {/*    <StaffCarousel staff={staff}/>*/}
            {/*</Section>}*/}
            <Section name="FAQ" capitalize={true} side="right" dino={crocs[3]} font={"font-sans"} image={"assets/crocs/croc-faq.png"}>
                <FAQ data={FAQ_DATA}/>
            </Section>

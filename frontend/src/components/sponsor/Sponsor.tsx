    ...
    const tapsiSections = [
        {
            ...
            , image: "assets/sponsor/tapsi1.webp"
        },
        {
            title: "تپسی تلفنی",
            ...
            , image: "assets/sponsor/tapsi2.webp"
        },
        {
            title: "تپسی لاین",
            ...
            , image: "assets/sponsor/tapsi3.webp"
        },
        {
            title: "موتوپیک",
            ...
            , image: "assets/sponsor/tapsi4.webp"
        },
        {
            title: "اتوپیک",
            ...
            , image: "assets/sponsor/tapsi5.webp"
        },
        {
            title: "تپسی پلاس",
            ...
            , image: "assets/sponsor/tapsi6.webp"
        },
    ...
    return (
        <>
            ...
            <Section nameColor={"#FF5B35"} name="Tapsi ~ Sponsor of Event" side="left" dino={1}
                     image={"assets/sponsor/tapsi-logo-fa.png"} font={"font-dana-regular"}>
                <TextOnlySection
